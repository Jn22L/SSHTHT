# 심심할땐 바닐라JS로 웹사이트 만들면서 놀기, 바닥부터 한땀한땀
...
- 할일 클릭시 todolist.js 의 경로에 my-simsim-site 누락되어 못불러오는 문제발생
...
- 절대경로로 설정하여 github 올림
  ...
  - 이때 주소창에 my-simsim-site 가 없는것을 발견 .. 아
- 상대경로로 pushState 설정하여 github 올림
  - `history.pushState('','',"./nave__todo")`
  - 상대경로 올렸을때 할일 url : https://jn22l.github.io/my-simsim-site/nav__home
  - 상대경로 올렸을때 할일 js : https://jn22l.github.io/my-simsim-site/todolist.js -> 잘찾음!!! 어휴ㅎ
